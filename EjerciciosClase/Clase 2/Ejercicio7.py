...
#FUNCION 1 - BUSCAR LA POSICIÓN DE LA PALABRA
position= text.find("Lorem")
print(f"Posición: {position}")

#FUNCION 2 - CANTIDAD DE APARICIONES DE LA PALABRA
repeticion= text.count("texto")
print(f"Repetición: {repeticion}")

#FUNCION 3 - REEMPLAZAR UNA PALABRA
reemplazar= text.replace("Lorem Ipsum", "ARIAL BLACK")
print(f"\nNuevo texto: {reemplazar}")
